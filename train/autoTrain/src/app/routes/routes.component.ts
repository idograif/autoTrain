...
export class RoutesComponent implements OnInit {
  ...
  constructor(private routeService: RouteService, private formSaveService: FormSaveService) { }
  ...
  order(route: Route) {
    ...
    window.location.href = `https://www.rail.co.il/taarif/pages/ordervaucherallcountry.aspx?TNUM=${route.Train[0].Trainno}&FSID=${this.formSaveService.form.from}&TSID=${this.formSaveService.form.to}&DDATE=${this.formSaveService.date}&Hour=${this.formSaveService.hour}&CS=null&TSP=1608410010081`
